                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(category, index) in categories" :key="index">
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm" v-on:click="editCategory(category)"><span class="fa fa-edit"></span>Edit</button>
                                <button class="btn btn-danger btn-sm" v-on:click="deleteCategory(category)"><span class="fa fa-trash"></span>Delete</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
